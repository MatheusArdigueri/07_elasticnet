...
weather_recipe <-
  ...
  recipe(strength_gtex ~ .,
         data = weather_train
         ) %>% #. say all the columns of the dataset
  ...
  # 
  # # Decorrelating
  # step_pca(all_numeric_predictors(), threshold = .8) #It should keep however many pcs are need to explain at least 80% of variation.
